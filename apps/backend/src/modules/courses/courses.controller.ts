...
export class CoursesController {
  ...
  async createCourse(@Body() dto: CreateCourseDto, @Request() req: RequestWithUser) {
    return this.coursesService.create(req.user.id, dto);
  }

  @Patch('courses/:id')
  @UseGuards(JwtAuthGuard)
  async updateCourse(@Param('id') id: string, @Body() dto: UpdateCourseDto, @Request() req: RequestWithUser) {
  ...
  @UseGuards(JwtAuthGuard)
  async getLessonVideo(@Param('id') id: string, @Request() req: RequestWithUser) {
  ...
  @Post('lessons')
  @UseGuards(JwtAuthGuard)
  async createLesson(@Body() dto: CreateLessonDto & { courseId: string }, @Request() req: RequestWithUser) {
    return this.lessonsService.create(dto.courseId, dto);
  }

  @Patch('lessons/:id')
  @UseGuards(JwtAuthGuard)
  async updateLesson(@Param('id') id: string, @Body() dto: UpdateLessonDto, @Request() req: RequestWithUser) {
  ...
  @Delete('lessons/:id')
  @UseGuards(JwtAuthGuard)
  async deleteLesson(@Param('id') id: string, @Request() req: RequestWithUser) {
  ...
  @UseGuards(JwtAuthGuard)
  async getUploadUrl(@Param('id') id: string, @Request() req: RequestWithUser) {
    return this.lessonsService.getUploadUrl(id, req.user.id);
  }

  @Post('enrollments')
  @UseGuards(JwtAuthGuard)
  async enroll(@Body() body: { courseId: string }, @Request() req: RequestWithUser) {
    return this.enrollmentsService.enroll(req.user.id, body.courseId);
  }

  @Get('enrollments/my')
  @UseGuards(JwtAuthGuard)
  async myEnrollments(@Request() req: RequestWithUser) {
  ...
  @UseGuards(JwtAuthGuard)
  async unenroll(@Param('id') id: string, @Request() req: RequestWithUser) {
  ...
  @UseGuards(JwtAuthGuard)
  async updateProgress(@Param('id') id: string, @Body() dto: UpdateProgressDto, @Request() req: RequestWithUser) {
    return this.enrollmentsService.updateProgress(id, req.user.id, dto);
  }

  @Get('enrollments/:id/progress')
  @UseGuards(JwtAuthGuard)
  async getProgress(@Param('id') id: string, @Request() req: RequestWithUser) {
    return this.enrollmentsService.getProgress(id, req.user.id);
  }

  @Post('enrollments/:id/certificate')
  @UseGuards(JwtAuthGuard)
  async generateCertificate(@Param('id') id: string, @Request() req: RequestWithUser) {
    return this.certificateService.generate(id, req.user.id);
  }

  @Get('certificates/:id')
  @UseGuards(JwtAuthGuard)
  async getCertificate(@Param('id') id: string, @Request() req: RequestWithUser) {
